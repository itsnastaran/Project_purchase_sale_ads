...
namespace Utility
{ 
    public partial class ManageDate
    {
        /// <summary>
        /// برای کار کردن با تقویم  هجری شمسی
        /// </summary>
        public partial class ManageDatePersianCalendar
        {
            public struct PDate
            {
                public int year;
            ...
            public class DateWork
            {
                ...
                /// </summary>
                /// <returns></returns>      
                public string GetNameDayInMonth(DateTime now)
                {

                    string Resme = "";
                    string Res;
                    PersianCalendar DateFme = new PersianCalendar();
                    Res = DateFme.GetDayOfWeek(now).ToString();
                    switch (Res)
                    {
                        case "Saturday":
                            {
                ...
                /// </summary>
                /// <returns></returns>      
                public string GetNameMonth(DateTime now)
                {

                    string Resme = "";
                    string Res;
                  PersianCalendar DateFme = new PersianCalendar();
                  Res = DateFme.GetMonth(now).ToString();
                    switch (Res)
                    {
                        case "1":
                            {
                ...
                public string GetNameMonthShamsi(string Res)
                {
                    string Resme = "";
                    switch (Res)
                    {
        ...
        /// </summary>
        public partial class ManageDateArabicCalendar
        {
            public struct PDate
            {
                public int year;
            ...
            public class DateWork
            {
                ...
                /// </summary>
                /// <returns></returns>      
                public string GetNameMonth(string Res)
                {
        ...
        /// </summary>
        public partial class ManageDateNumberToPersianText
        {
